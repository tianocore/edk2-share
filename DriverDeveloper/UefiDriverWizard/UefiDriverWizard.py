...
class UefiDriverWizard ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.LogMessageWindow.SetMaxLength( 0 )
...
class NewUefiDriver ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.UefiDriverName.SetMaxLength( 0 )
		...
		self.UefiDriverVersion.SetMaxLength( 0 )
		...
		self.UefiDriverGuid.SetMaxLength( 0 )
		...
		self.UefiDriverType.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.DriverBindingVersion.SetMaxLength( 0 )
		...
		self.UefiSpecificationVersion.SetMaxLength( 0 )
...
class UefiDriverModelOptionalFeatures ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.Rfc4646LanguageCodes.SetMaxLength( 0 )
		...
		self.Iso639LanguageCodes.SetMaxLength( 0 )
...
class UefiDriverModelProducedProtocols ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.UsbMajorVersion.SetMaxLength( 0 )
		...
		self.UsbMinorVersion.SetMaxLength( 0 )
...
class NewPackage ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.PackageName.SetMaxLength( 0 )
		...
		self.PackageGuidValue.SetMaxLength( 0 )
		...
		self.PackageVersion.SetMaxLength( 0 )
		...
		self.PlatformGuidValue.SetMaxLength( 0 )
...
class NewProtocol ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.ProtocolGuidValue.SetMaxLength( 0 )
		...
		self.ProtocolIncludeName.SetMaxLength( 0 )
...
class NewGuid ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.GuidIncludeName.SetMaxLength( 0 )
...
class NewLibraryClass ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.LibraryClassIncludeName.SetMaxLength( 0 )
