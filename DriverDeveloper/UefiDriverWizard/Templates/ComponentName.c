...
///
GLOBAL_REMOVE_IF_UNREFERENCED 
EFI_UNICODE_STRING_TABLE m<<DriverName>>DriverNameTable[] = {
  { "<<Iso639SupportedLanguages>>;<<Rfc4646SupportedLanguages>>", (CHAR16 *)L"<<DriverName>>" },
  { NULL, NULL }
};
  ...
  )
{
  return LookupUnicodeString2 (
           ...
           DriverName,
           (BOOLEAN)(This != &g<<DriverName>>ComponentName2)
           );
}
...
<<BEGIN>><<UefiDriverModelBusDriverEnabled>>
  ...
  if (ChildHandle == NULL) {
    ...
    //
    // Lookup name of child specified by ControllerHandle and ChildHandle
    //
    Status = EFI_UNSUPPORTED;
  }
<<END>>
