...
class PackageDocMainFrame(wx.Frame):
    def __init__(self, parent, title):
        wx.Frame.__init__(self, parent, -1, title, size=(550, 400), style=wx.MINIMIZE_BOX|wx.SYSTEM_MENU|wx.CAPTION|wx.CLOSE_BOX )
        ...
        sizer.Add(wx.StaticText(panel, -1, 'Preprocess Macros: (seperate with blank such as "DEBUG RELEASE")'), 0, wx.EXPAND|wx.LEFT|wx.RIGHT, 5)
        
        self._macroCtrl = wx.TextCtrl(panel, -1, '')
        sizer.Add(self._macroCtrl, 0, wx.EXPAND|wx.TOP|wx.LEFT|wx.RIGHT, 5)
        self._macroCtrl.Bind(wx.EVT_TEXT, self.OnMacroText)
        self._allMacroCtrl = wx.TextCtrl(panel, -1, 'MDE_CPU_IA32 MDE_CPU_X64 MDE_CPU_EBC MDE_CPU_IPF MDE_CPU_ARM _MSC_EXTENSIONS __GNUC__ __INTEL_COMPILER ASM_PFX= OPTIONAL= ', 
                                           size=(-1, 50), style=wx.BORDER_STATIC|wx.TE_READONLY|wx.TE_MULTILINE)
        sizer.Add(self._allMacroCtrl, 0, wx.EXPAND|wx.TOP|wx.LEFT|wx.RIGHT, 5)
