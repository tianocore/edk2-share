...
class PackageDocumentAction(DoxygenAction):
        ...
        for obj in objs:
            ...
            for file in os.listdir(path):
                ...
                if os.path.isfile(fullpath):
                    ...
                    if file.lower() in ['library', 'protocol', 'guid', 'ppi', 'ia32', 'x64', 'ipf', 'ebc', 'arm', 'pi', 'uefi']:
                        continue
    ...
    def GenerateModulePage(self, pObj, infObj, configFile, isLib):
        ...
        for obj in infObj.GetSourceObjects(self._arch, self._tooltag):
            ...
            if sPath.lower().endswith('.uni') or sPath.lower().endswith('.s') or sPath.lower().endswith('.asm'):
